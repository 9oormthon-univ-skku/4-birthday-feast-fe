        ...
        <div className="flex items-center gap-3">
          {showBack && (
            <button
              ...
              aria-label="뒤로가기"
              onClick={handleBack}
              className="flex h-full items-center justify-center rounded-full border border-transparent bg-transparent transition active:scale-95"
            >
              {backArrow}
            </button>
          )}
...
const backArrow = (
  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="18" viewBox="0 0 10 18" fill="none">
    <path
      d="M8 2L0.999938 9.00006L8 16.0001"
      stroke="#A0A0A0"
      strokeWidth="3"
      strokeLinecap="round"
